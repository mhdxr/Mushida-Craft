          ...
          {trustItems.map((item) => {
            ...
            return (
              <div key={item.title} className="group flex gap-4">
                <span className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-blush-50 to-cream-100 text-primary ring-1 ring-blush-100/60 shadow-[0_4px_16px_-6px_rgba(var(--shadow-blush-rgb),0.4)] transition-transform duration-300 group-hover:scale-105">
