...
export function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-50 isolate w-full border-b border-blush-100/30 bg-white/70 backdrop-blur-md shadow-[0_4px_24px_-8px_rgba(var(--shadow-blush-rgb),0.08)]">
